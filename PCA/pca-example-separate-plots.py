...
plt.savefig('DWGs/python-raw-data.png', dpi = 300)
...
plt.axis('equal')
plt.yticks([-1, 0, 1]), plt.xticks([-1, 0, 1])
plt.savefig('DWGs/python-PCs.png', dpi = 300)
...
plt.savefig('DWGs/python-PC-scores.png', dpi = 300)
