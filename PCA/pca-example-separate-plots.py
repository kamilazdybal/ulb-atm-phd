...
plt.savefig('DWGs/python-raw-data.eps', dpi = 100)
...
plt.savefig('DWGs/python-data-centered.eps', dpi = 100)
...
plt.axis('equal')
plt.yticks([-1, 0, 1]), plt.xticks([-1, 0, 1])
plt.savefig('DWGs/python-PCs.eps', dpi = 100)
...
plt.savefig('DWGs/python-PC-scores.eps', dpi = 100)
