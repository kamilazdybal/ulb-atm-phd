...
\begin{figure}[H]
\centering\includegraphics[width=6cm]{python-raw-data.pdf}
...
\begin{figure}[H]
\centering\includegraphics[width=6cm]{python-data-centered.pdf}
...
\begin{figure}[H]
\centering\includegraphics[width=6cm]{python-PCs.pdf}
...
\begin{figure}[H]
\centering\includegraphics[width=6cm]{python-PC-scores.pdf}
\caption{PC-scores.}
