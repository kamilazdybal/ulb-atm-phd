...
All of these questions are not necessarily answerd by PCA. Different applications might work well with different data reduction techniques. However, I believe that they form a strong motivation to why we are dealing with data science and how important it can be in various physical and computer sciences.
