...
\begin{figure}[H]
\centering\includegraphics[width=7cm]{../python-graphs/PCA-fake-datasets/PCA_linear_scatter_1.png}
...
\begin{figure}[H]
\centering\includegraphics[width=7cm]{../python-graphs/PCA-fake-datasets/PCA_nonlinear_scatter_2.png}
