...
In other words, what we want to achieve with PCA is to diagonalize this new covariance matrix $\bm{S_Z}$. It uses as a "template" a diagonal matrix that was already produced, and which is guaranteed to be diagonal - the matrix of eigenvalues $\bm{\Lambda}$.
