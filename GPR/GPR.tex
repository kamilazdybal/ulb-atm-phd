...
\subsection{The meaning of hyperparameters}
...
pool": all functions have a Gaussian marginal distribution. (Though it does not need to be a case either - GPML uses other likelihoods - but we still call the technique \textbf{Gaussian} Process Regression). In other words, the histogram of realisations' values begin to look like a normal distribution as the number of realisations increase.
