...
Let's associate a certain number, say $\lambda$, to describe the evolution in time. Each element of the animation will have its own $\lambda$.
...
\bibitem{Andymation} https://www.youtube.com/watch?v=ZCCETV-8950 \label{bib:andymation}
